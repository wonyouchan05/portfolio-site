      ...
      <section className="border-t border-border-2 bg-bg-alt px-6 py-[clamp(50px,8vw,90px)] sm:px-10 lg:px-20">
        <div className="mx-auto max-w-[880px]">
          ...
          <div className="flex max-w-[640px] flex-col gap-3.5">
            ...
            <p className="m-0 text-[15.5px] leading-[1.75] text-body">
              만들고 나서도 정작 저부터 매번 &ldquo;봐야지, 봐야지&rdquo; 하고 잊어버리는 문제가
              있었습니다. 지금은 반마다 꼼꼼히 챙기는 친구 한 명에게 등록을 부탁하는 방식으로
              운영하고 있습니다.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto flex max-w-[880px] flex-col gap-6">
          ...
          <div className="flex max-w-[640px] flex-col gap-3.5">
            ...
            <p className="m-0 text-[15.5px] leading-[1.75] text-body">
              ...
              걸리고 어렵다는 걸 이번에 알게 됐습니다. 색상 대비, 여백, 반응형 레이아웃처럼 눈에
              안 띄지만 계속 확인해야 하는 디테일이 많았고, 이 과정에서 디자인을 보는 눈을 조금씩
              익힐 수 있었습니다.
            </p>
          </div>
